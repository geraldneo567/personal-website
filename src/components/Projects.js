            ...
            <div className="container" style={{marginBottom: 50}}>
                <div className="row d-flex justify-content-center mb-4">
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center">
                        <Card style={{ height: '23rem', width: '23rem', borderRadius: "20%", backgroundColor: "#840c24"}}>
                            <Card.Img variant="top" src={resumeAnywhereLogo} style={{width: '125px', height: '125px', alignSelf: 'center', marginTop: "20px"}}/>
                    ...
                    <div className="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center">
                        <Card style={{ height: '23rem', width: '23rem', borderRadius: "20%", backgroundColor: "#016064"}}>
                            <Card.Img variant="top" src={gerousell} style={{width: '125px', height: '125px', alignSelf: 'center', marginTop: "20px"}}/>
                            <Card.Body className={"text-center"} style={{color: 'white'}}>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center">
                        <Card style={{ height: '23rem', width: '23rem', borderRadius: "20%", backgroundColor: "#22190e"}}>
                            <Card.Img variant="top" src={website} style={{width: '125px', height: '125px', alignSelf: 'center', marginTop: "20px"}}/>
                            <Card.Body className={"text-center"} style={{color: 'white'}}>
